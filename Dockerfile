...
# パッケージのインストール
RUN (apt update || apt install -y curl && sudo curl -sSL https://raw.githubusercontent.com/ros/rosdistro/master/ros.key  -o /usr/share/keyrings/ros2-latest-archive-keyring.gpg && \
